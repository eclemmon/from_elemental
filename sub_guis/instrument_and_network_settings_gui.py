...
class InstrumentNetworkSettingsGui(tk.Toplevel):
    ...
    def __init__(self, root, color_1="light steel blue", color_2="snow", color_3="steel blue"):
        ...
        # Initialize header
        self.header_frame = tk.Frame(self, bg=color_1)
        ...
        self.v_vcl_selector = tk.Label(self.header_frame, text="SELECT YOUR INSTRUMENT",
                                       font=("Rosewood Std Regular", 40), pady=10, padx=10, fg=color_2, bg=color_1)
        self.v_vcl_selector.grid(row=1, columnspan=3)
        self.header_frame.grid_columnconfigure(0, weight=1)
        self.header_frame.grid_columnconfigure(2, weight=1)

        # Set up radio buttons for instruments
        self.instrument_buttons_frame = tk.Frame(self, bg=color_2)
        ...
        self.cello_button = tk.Radiobutton(self.instrument_buttons_frame, text="Cello", variable=self.instrument, value=1,
                                           font=("Rosewood Std Regular", 20), pady=10, fg=color_3, bg=color_2)
        ...
        self.networked_or_not_text_frame = tk.Frame(self, bg=color_1)
        ...
        self.network_button_frame = tk.Frame(self, bg=color_2)
        ...
        self.image_trigger_selection_frame = tk.Frame(self, bg=color_1)
        ...
        self.image_trigger_button_frame = tk.Frame(self, bg=color_2)
        ...
        # Pre-roll option
        self.preroll_label_frame = tk.Frame(self, bg=color_1)
        ...
        self.preroll_label = tk.Label(self.preroll_label_frame, text="AMOUNT OF PRE-ROLL", pady=10, padx=5,
                                      font=("Rosewood Std Regular", 20), fg=color_2,
                                      bg=color_1)
        ...
        self.fill_frame = tk.Frame(self, bg=color_2)
        ...
        # Submit button
        self.submit_button_frame = tk.Frame(self, bg=color_1)
